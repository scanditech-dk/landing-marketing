...
import {
  DesignYourWorkflowSkeleton as ImportedDesignYourWorkflowSkeleton,
  DeployAndScaleSkeleton as ImportedDeployAndScaleSkeleton,
} from "../how-it-works/skeletons";
...
export const WorkflowCarousel = () => {
  const skeletons = [
    { id: "design", component: <ImportedDesignYourWorkflowSkeleton /> },
    { id: "deploy", component: <ImportedDeployAndScaleSkeleton /> },
  ];
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setActiveIndex((prev) => (prev + 1) % skeletons.length);
    }, DURATION);
  ...
  return (
    <div className="relative mx-auto mt-2 w-[85%] p-4">
      <AnimatePresence mode="wait">
        <motion.div
          key={skeletons[activeIndex].id}
