...
export const TenderIcon = (
  ...
  return (
    ...
    >
      <path
        d="M14.167 8.854V4.817c0-1.19 0-1.786-.232-2.24a2.13 2.13 0 0 0-.928-.929c-.455-.231-1.05-.231-2.24-.231H6.234c-1.19 0-1.786 0-2.24.231-.4.204-.725.53-.929.929-.232.454-.232 1.05-.232 2.24v7.366c0 1.19 0 1.786.232 2.24.204.4.529.725.929.929.454.231 1.05.231 2.24.231H8.5m1.417-7.791h-4.25m1.417 2.833H5.667m5.667-5.667H5.667m4.604 8.5 1.417 1.417 3.187-3.187"
        stroke="currentColor"
        strokeWidth="1.33333"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const CositngIcon = (
  ...
  return (
    ...
    >
      <path
        d="M14.167 14.167V9.208M8.5 14.167V7.083m-5.666 7.084v-2.834m6.663-7.772 3.66 1.373M7.65 3.826 3.684 6.8m11.234-2.24a1.062 1.062 0 1 1-1.502 1.503 1.062 1.062 0 0 1 1.502-1.503M3.585 6.686A1.063 1.063 0 1 1 2.082 8.19a1.063 1.063 0 0 1 1.503-1.503m5.666-4.25A1.062 1.062 0 1 1 7.75 3.94a1.062 1.062 0 0 1 1.5-1.504"
        stroke="currentColor"
        strokeWidth="1.33333"
        strokeLinecap="round"
        strokeLinejoin="round"
